<x-app-layout>
    <x-slot name="header">
        <x-ui.section-header title="Nueva transacción" eyebrow="Registra un ingreso o gasto." :back="route('transactions.index')" />
    </x-slot>
            ...
            <x-ui.card padding="p-7 sm:p-8">
                <form method="POST" action="{{ route('transactions.store') }}">
                    ...
                    <div class="flex items-center justify-end mt-7 gap-3 pt-5 border-t border-slate-200 dark:border-slate-800">
                        ...
                        <x-ui.button type="submit" variant="primary" icon="check">Guardar transacción</x-ui.button>
                    </div>
                </form>
            </x-ui.card>
        </div>
